...
namespace Hdweb\Coreoverride\Controller\Checkout\Index;
...
class Index extends \Magento\Checkout\Controller\Index\Index
{
    ...
    public function execute()
    {
        ...
        /* start redirect to checkout if installer is not selected */
        

        if (!$quote->getPickupDate() || !$quote->getPickupTime() || !$quote->getPickupStore()) {
            $this->messageManager->addErrorMessage(__('Please select with fitting or without fitting and proceed to checkout.'));
            return $this->resultRedirectFactory->create()->setPath('checkout/cart');
        }
        /* end redirect to checkout if installer is not selected */
