...
class Save extends \Hdweb\Insurance\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('hdweb/insurance');
                        ...
                        $imagePath = 'hdweb/insurance'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('hdweb_insurance/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('hdweb_insurance/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('hdweb_insurance/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('hdweb_insurance/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('hdweb_insurance/*/');
