...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Hdweb_Rfc::Rfc')
            ->addBreadcrumb(__('Hdweb Rfc'), __('Hdweb Rfc'))
            ->addBreadcrumb(__('Manage Item'), __('Manage Rfc Import'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $id = $this->getRequest()->getParam('supplierproducts_id');
        ...
        $this->_coreRegistry->register('rfc', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($id ? __('RFC Import') : __('RFC Import'));
