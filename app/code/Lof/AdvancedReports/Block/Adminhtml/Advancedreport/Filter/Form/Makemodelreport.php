 ...
 */
class Makemodelreport extends \Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Filter\Form
{
    ...
    function makeoption(){
        ...
        $sizeblockObj=$_objectManager->create("Hdweb\Tyrefinder\Block\Vehicle");
        $allmake=$sizeblockObj->getVehilceMake();
         $allmake = json_decode(json_encode($allmake), FALSE);
        $makeoption[]='Select';
