...
class Attribute extends \MGS\Ajaxlayernavigation\Model\Layer\Filter\DefaultFilter
{
    ...
    public function apply(\Magento\Framework\App\RequestInterface $request)
    {
		...
		/* Start filter product collection by bundle list */
		$isBundle = $this->serchHelper->isBundle();
		if($isBundle){
			$skus = $this->serchHelper->getFilterProductSkus();
			$productCollection->addAttributeToFilter('sku', array('in' => $skus));
		}
		/* End filter product collection by bundle list */
