 ...
 */
class BrandPatternmanagement extends \Magento\Backend\Block\Widget\Form\Renderer\Fieldset\Element implements \Magento\Framework\Data\Form\Element\Renderer\RendererInterface
{
	/** @var string Template */
	...
	/**
	 * BrandPatternmanagement constructor.
	...
	{
		$optionIds     = [];
		$model         = $this->coreRegistry->registry('current_brand_patternmanagement');
