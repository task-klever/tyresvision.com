...
class Brand extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
	...
	protected function _prepareForm()
	{
		...
		/** @var \Mageplaza\Shopbybrand\Model\Patternmanagement $model */
		...
		$renderer = $this->getLayout()->createBlock('Mageplaza\Shopbybrand\Block\Adminhtml\Form\Renderer\BrandPatternmanagement');
