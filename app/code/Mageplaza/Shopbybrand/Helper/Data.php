...
class Data extends AbstractHelper
{
     ...
     * Pattern media path
     */
    const PATTERN_MEDIA_PATH = 'mageplaza/pattern';
    ...
    public function getHomepageBrandUrl($brand = null)
    {
        $baseUrl = $this->storeManager->getStore()->getBaseUrl();
        //$key     = is_null($brand) ? '' : '/' . $this->processKey($brand);
        return $baseUrl . '/car-tyres.html?mgs_brand=' . $brand->getId(); //. $key . $this->getUrlSuffix();
    }
