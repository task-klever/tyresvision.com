...
class Response extends Action
{
    ...
    public function execute()
    {
		...
		$_checkoutSession = $objectManager->create('\Magento\Checkout\Model\Session');
        $this->tempFix_GuestSuccessPage($_checkoutSession, $orderEntityId, $quoteId, $orderId);
	...
	private function tempFix_GuestSuccessPage($session, $orderId, $quoteId, $orderIncrementId)
    {
        if (
