...
{
    const XML_PATH_TARGET_XPATH = 'product/spotiipay/xpath';
    const XML_PATH_PAYMENT_ACTIVE = 'payment/spotiipay/active';
    const XML_PATH_RENDER_TO_PATH = 'product/spotiipay/render_x_path';
    const XML_PATH_FORCED_SHOW = 'product/spotiipay/forced_show';
    const XML_PATH_ALIGNMENT = 'product/spotiipay/alignment';
    const XML_PATH_THEME = 'product/spotiipay/theme';
    const XML_PATH_WIDTH_TYPE = 'product/spotiipay/width_type';
    const XML_PATH_IMAGE_URL = 'product/spotiipay/image_url';
    const XML_PATH_HIDE_CLASS = 'product/spotiipay/hide_classes';
