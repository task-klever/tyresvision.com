...
define('CAMPAIGN_ID', "7037c93fdd8203dc5aaa0ca2f38b2a3e");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '0d1bb3d78354550fcb6a355cab155316');
define('MP_PARAM_NAME', '_gi_sess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '208b484f33d1aa87900c76a60ae415bb');
define('CHECK_MCPROXY_VALUE', '2211fc0034106e0fc04f0d8157cfc46640542dc8c622461f24f68025d0892179');
...
function sendRequest($data, $path = 'index') {
  ...
  $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '19799.3');
